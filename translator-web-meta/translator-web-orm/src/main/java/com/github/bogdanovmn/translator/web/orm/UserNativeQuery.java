...
public class UserNativeQuery {
	public static final String TO_REMEMBER_WORDS_RARE =
		"select w.*"
			+ " from  word w"
	...
	public static final String TO_REMEMBER_WORDS_FREQUENT = TO_REMEMBER_WORDS_RARE + "desc";

	public static final String TO_REMEMBER_WORDS =
